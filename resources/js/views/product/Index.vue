                  ...
                  <div
                    ...
                    <div class="short-by">
                      <div class="select-box">
                        <select v-model="sortingSelect" @change="selectFilter" class="wide select-simple-filter">
                      ...
                      <div v-for="product in products" class="col-xl-4 col-lg-6 col-6">
                        <div class="products-three-single w-100  mt-30">
                          <div class="products-three-single-img"><router-link
                            ...
                            <a @click.prevent="addToCart(product, 1)" href="#" class="addcart btn--primary style2">
                              Add To Cart </a>
                            <div class="products-grid__usefull-links">
                              <ul>
                                <li><a href="#"> <i class="flaticon-heart">
                                </i> <span>
                                                                            wishlist</span> </a></li>
                                <li><a href="#"> <i
                                  ...
                                  <div class="quick-view__left-content">
                                    <div class="tabs">
                                      ...
                                      <div class="popup-product-main-image-box">
                                        ...
                                        <button class="prev" v-if="product.product_images.length > 1"><i
                                            class="flaticon-back"></i>
                                        </button>
                                        <button class="next" v-if="product.product_images.length > 1"><i
                                  ...
                                  <div class="popup-right-content">
                                    ...
                                    <div class="price">
                                      <h2> ${{ product.price }} USD
                                        <del v-if="product.old_price>0"> ${{ product.old_price }} USD</del>
                                      </h2>
                                      <h6> In stuck</h6>
                                    </div>
                                    <div class="add-product">
                                      ...
                                      <div class="button-group">
                                        ...
                                        <button @click.prevent="addToCart(product, 999)" class="btn--primary "> Add to
                                          Cart
                                        </button>
                                      </div>
                                    </div>
    ...
    getProduct(id) {
      this.axios.post(`/api/products/${id}`)
          .then(res => {
            ...
            console.log(this.popupProduct.product_images);
          }).finally(v => {
        $(document).trigger('changed')
      })
    },
