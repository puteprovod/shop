<template>
    <div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="menu-info d-flex justify-content-between align-items-center">
                                            ...
                                            <router-link
                                                to="/" class="logo"> <img src="/assets/images/logo/logo.png"
                                                                                     alt=""> </router-link>
                    ...
                    <div class="d-lg-block d-none">
                        <div class="row g-0 position-relative">
                            <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
                                <div class="logo"><router-link to="/"> <img src="/assets/images/logo/logo.png" alt="">
                                </router-link>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="some-info">
                                            <p class="d-flex align-items-center"> <span class="icon"> <i
                                                class="flaticon-power"></i> </span> Welcome to Cart Online Shop</p>
                                            <div class="right d-flex align-items-center ">
                                                ...
                                                <div style="padding-right: 30px;"><select>
                                            ...
                                            <div class=" d-flex align-items-center justify-content-between ">
                                                ...
                                                <div class="right d-flex align-items-center justify-content-end">
                                                    <ul class="main-menu__widge-box d-flex align-items-center ">
                                                        ...
                                                        <li class="d-lg-block d-none"><router-link to="/wishlist"
                                                                                         class="number"><i
                                                            class="flaticon-heart"></i> <span
                                                            class="count" v-if="getWLCount>0">({{ getWLCount }})</span> </router-link></li>
                                                        <li class="cartm"><a href="#0" class="number cart-icon"> <i
                                                            class="flaticon-shopping-cart"></i><span
                                                            class="count" v-if="getCartCount>0">({{ getCartCount }})</span> </a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <a href="#" class="offer-link"> Offer </a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="menu-info d-flex justify-content-between align-items-center">
                                    <div class="menubar"><span></span> <span></span> <span></span></div>
                                    <router-link
                                        to="/" class="logo"> <img src="/assets/images/logo/logo.png" alt="">
                                    </router-link>
                                    <div class="cart-holder">
                                        <a href="#0" class="cart cart-icon position-relative">
                                            <i class="flaticon-shopping-cart"></i>
            ...
            <div class="side-cart d-flex flex-column justify-content-between">
                <div class="top">
                    <div class="content d-flex justify-content-between align-items-center">
                        <h6 class="text-uppercase">Your Cart ({{ getCartCount }})</h6> <span class="cart-close text-uppercase">X</span>
                    </div>
                        ...
                        <div v-for="product in products"  class="items d-flex justify-content-between align-items-center">
                            <div class="left d-flex align-items-center"><a href="shop-details-1.html"
                                ...
                                <div class="text"><a href="shop-details-1.html">
                                    ...
                                    <p>{{ product.qty }} X <span>${{ product.price }}.00</span></p>
                                </div>
                            </div>
                            <div class="right">
                                <div class="item-remove"><i class="flaticon-cross" @click.prevent="removeProduct(product.id)"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bottom">
                    <div class="total-ammount d-flex justify-content-between align-items-center">
                        ...
                        <h6 class="ammount text-uppercase">${{ subtotal }}.00</h6>
                    </div>
                    <div class="button-box d-flex justify-content-between">
                        <router-link to="/cart" class="btn_black"> View Cart
                        </router-link>
                        <router-link to="/cart" class="button-2 btn_theme"> Chekout </router-link></div>
                </div>
            </div>
                    ...
                    <div class="sidebar-textwidget">
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                <div class="logo"><a href="#"><img src="/assets/images/logo/logo-2.png" alt=""></a>
                                </div>
        ...
        <router-view @addcart="getCartProducts" @addwl="getWL"></router-view>
                ...
                <div class="container">
                    <div class="footer_bottom_content">
                        <div class="copyright wow fadeInUp animated">
                            <p>© 2023 <router-link to="/">Cart.</router-link> All Rights Reserved.</p>
                        </div>
